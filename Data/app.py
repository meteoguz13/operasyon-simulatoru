...
tam_tatiller = {
    ...
    "2027-05-16","2027-05-17","2027-05-18","2027-05-19","2027-07-15",
    "2027-08-30","2027-10-29",
}
arifeler = {
    "2024-04-09","2024-06-15","2024-10-28","2024-12-31",
    "2025-03-29","2025-06-05","2025-10-28","2025-12-31",
    "2026-03-19","2026-05-26","2026-10-28","2026-12-31",
    "2027-03-08","2027-05-15","2027-10-28","2027-12-31",
}
...
with sekme_yil:
    ...
    with c1:
        yil_sec = st.selectbox("Planlama yılı", [2026, 2027])
    with c2:
        st.markdown(
            f"""
